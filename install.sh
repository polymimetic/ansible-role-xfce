...
# https://github.com/polymimetic/ansible-role-xfce
#
...
#
# Usage:
# wget -qO - https://raw.githubusercontent.com/polymimetic/ansible-role-xfce/master/install.sh | bash
#
###########################################################################
...
readonly GIT_REPO="https://github.com/polymimetic/ansible-role-xfce.git"
readonly GIT_RAW="https://raw.githubusercontent.com/polymimetic/ansible-role-xfce/master"
...
install_xfce() {
  ...
  local xfce_files="${SCRIPT_PATH}/files/xfce"
